...
Singleton {
    ...
    // Waybar-matching defaults (pywal file overrides when present)
    property color background: "#121212"
    property color foreground: "#f1f5f9"
    property color cursor: "#f1f5f9"
    
    // Individual color properties for easy access
    property color color0: "#121212"
    property color color1: "#fca5a5"
    property color color2: "#6ee7b7"
    property color color3: "#fdba74"
    property color color4: "#7ebae4"
    property color color5: "#c084fc"
    property color color6: "#a78bfa"
    property color color7: "#f1f5f9"
    property color color8: "#94a3b8"
