...
- **Reverse Proxy & DNS** (`reverse-proxy.nix`, `dns.nix`): Local Nginx reverse proxy routing `jeff.lan` subdomains (`nextcloud.jeff.lan`, `jellyfin.jeff.lan`, `transmission.jeff.lan`) with dnsmasq resolution.
