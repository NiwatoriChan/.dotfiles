...

{
  services.homepage-dashboard = {
    enable = true;
    listenPort = 8082;
    allowedHosts = "localhost,127.0.0.1,[::1],192.168.0.10,jeff.lan,jeff,localhost:8082,127.0.0.1:8082,[::1]:8082,192.168.0.10:8082,jeff.lan:8082,jeff:8082";
